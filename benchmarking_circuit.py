...
from qiskit.aqua.algorithms.minimum_eigen_solvers.qaoa import QAOA
...
def make_benckmarks(circ_components: Optional[Union[Dict[str, int], List[Dict[str, int]]]]) -> Optional[Union[List[QuantumCircuit], List[List[QuantumCircuit]]]]:
    """
    QAOA circuit from: https://qiskit.org/textbook/ch-applications/qaoa.html#implementation
    """
