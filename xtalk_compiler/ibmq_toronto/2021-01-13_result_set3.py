...
def result_set3(): 
    ...
    job_dir = '/Users/Yasuhiro/Documents/aqua/gp/experiments/xtalk_compiler/ibmq_toronto/job_id/2021-01-13_set3'

    backend_name = 'ibmq_toronto'
    eval_path = dir_path + '/evaluations/2021-01-13_set3.pickle'

    # result_xtalk(job_dir, backend_name, eval_path)

    plot_path = dir_path + '/plot/2021-01-13_set3'
