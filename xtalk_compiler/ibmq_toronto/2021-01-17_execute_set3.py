...
def execute_set3():
    ...
    for label, name_list in enumerate(name_list_set): 
        ...
        shots_single=8192
        shots_multi=8192
        xtalk_prop = pickle_load('/Users/Yasuhiro/Documents/aqua/gp/errors_information/toronto_from20201224/xtalk_data_daily/ratio/2021-01-17.pickle')
        save_path = '/Users/Yasuhiro/Documents/aqua/gp/experiments/xtalk_compiler/ibmq_toronto/job_id/2021-01-17_set3/'+  str(label+3) +'.pickle'
