...
def execute_set3(today):
    ...
    for label, name_list in enumerate(name_list_set): 
        ...
        shots_single=8192
        shots_multi=8192
        xtalk_prop = pickle_load('/Users/Yasuhiro/Documents/aqua/gp/errors_information/toronto_from20201224/xtalk_data_daily/ratio/'+str(today)+'.pickle')
        save_path = '/Users/Yasuhiro/Documents/aqua/gp/experiments/xtalk_compiler/ibmq_toronto/job_id/'+str(today)+'_set3/'+  str(label) +'.pickle'
...
def execute_set4(today):
    ...
    for label, name_list in enumerate(name_list_set): 
        try: 
            ...
            shots_multi=8192
            xtalk_prop = pickle_load('/Users/Yasuhiro/Documents/aqua/gp/errors_information/toronto_from20201224/xtalk_data_daily/ratio/'+str(today)+'.pickle')
            save_path = '/Users/Yasuhiro/Documents/aqua/gp/experiments/xtalk_compiler/ibmq_toronto/job_id/'+str(today)+'_set4/'+  str(label) +'.pickle'
...
def execute_set5(today):
    ...
    for label, name_list in enumerate(name_list_set): 
        try: 
            ...
            shots_multi=8192
            xtalk_prop = pickle_load('/Users/Yasuhiro/Documents/aqua/gp/errors_information/toronto_from20201224/xtalk_data_daily/ratio/'+str(today)+'.pickle')
            save_path = '/Users/Yasuhiro/Documents/aqua/gp/experiments/xtalk_compiler/ibmq_toronto/job_id/'+str(today)+'_set5/'+  str(label) +'.pickle'
...
def execute_set6(today):
    ...
    for label, name_list in enumerate(name_list_set): 
        try:
            ...
            shots_multi=8192
            xtalk_prop = pickle_load('/Users/Yasuhiro/Documents/aqua/gp/errors_information/toronto_from20201224/xtalk_data_daily/ratio/'+str(today)+'.pickle')
            save_path = '/Users/Yasuhiro/Documents/aqua/gp/experiments/xtalk_compiler/ibmq_toronto/job_id/'+str(today)+'_set6/'+  str(label+pointer) +'.pickle'
