...
def execute_set6():
    ...
    name_list_set = load_gspread(worksheet_name='set_6', num_set=1, num_qc=6, shift=6)
    ...
    for label, name_list in enumerate(name_list_set): 
        ...
        save_path = '/Users/Yasuhiro/Documents/aqua/gp/experiments/xtalk_compiler/ibmq_toronto/job_id/2021-01-19_set6/'+  str(label+pointer) +'.pickle'
