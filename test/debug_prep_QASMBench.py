...
def save_small_bench(): 
    path = '/Users/Yasuhiro/Documents/aqua/gp/experiments/asap_scheduling/benchmarks/qasmbench_small.pickle'
    obj = debug_benchmark_prop()
    PrepQASMBench.save_pickle(obj, path)


def save_medium_bench(): 
    path = '/Users/Yasuhiro/Documents/aqua/gp/experiments/asap_scheduling/benchmarks/qasmbench_medium.pickle'
