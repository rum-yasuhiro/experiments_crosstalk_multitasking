...
def single_parallel_transpile(qc_list: List[QuantumCircuit], backend, layout_method=None, scheduling_method=None, instruction_durations=None, xtalk_prop=None): 
    
    qc_multi = multi_transpile(
        qc_list, backend=backend,
        basis_gates=['id', 'rz', 'sx', 'x', 'cx'],
        layout_method=layout_method, scheduling_method=scheduling_method, 
        instruction_durations=instruction_durations, xtalk_prop=xtalk_prop,
        )
