...
def result_set3(today): 
    ...
    job_dir = '/Users/Yasuhiro/Documents/aqua/gp/experiments/scheduling/ibmq_sydney/job_id/'+str(today)+'_set3'
...
def result_set4(today): 
    here_path = os.path.abspath(__file__)
    dir_path = os.path.dirname(here_path)
    job_dir = '/Users/Yasuhiro/Documents/aqua/gp/experiments/scheduling/ibmq_sydney/job_id/'+str(today)+'_set4'
...
def result_set5(today): 
    here_path = os.path.abspath(__file__)
    dir_path = os.path.dirname(here_path)
    job_dir = '/Users/Yasuhiro/Documents/aqua/gp/experiments/scheduling/ibmq_sydney/job_id/'+str(today)+'_set5'
...
def result_set6(today): 
    here_path = os.path.abspath(__file__)
    dir_path = os.path.dirname(here_path)
    job_dir = '/Users/Yasuhiro/Documents/aqua/gp/experiments/scheduling/ibmq_sydney/job_id/'+str(today)+'_set6'
